...
`AlkLayout` provides the shared page shell. Its public props are `title`, `description`, `section`, and `preview`, plus `navigation`, `moreNavigation`, and `footerNavigation`. See [site structure and navigation](/docs/site-structure/) for the link arrays and how to omit Docs in a consuming site.
