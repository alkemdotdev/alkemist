...
The palette is defined once in `packages/theme/src/palette.ts`. Run `npm run generate:palette` to regenerate CSS and the downloadable JSON. The regression check measures contrast against both surfaces.
