...
- `apps/site/src/content/notebook`: development articles.
...
The next feature milestone is an article containing math, a diagram, a real CSV chart, and a real GLB model viewer. The [component roadmap](/components/) distinguishes available features from proposed ones.
