...
Listings use the reusable [PostList component](/docs/post-lists/), which offers rows, grids, and featured lead layouts. Each site can choose a default or enable a reader layout selector.
