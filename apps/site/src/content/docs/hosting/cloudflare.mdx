...
Use the source generator with Node 24 from a cloned Alkemist checkout:
...
The generated directory is an independent Astro application. Commit its generated `package-lock.json` and package snapshots in `vendor/`.
