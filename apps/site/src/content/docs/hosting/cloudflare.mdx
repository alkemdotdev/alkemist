...
The registry beta interface is prepared but awaits the first npm publication. Until it is published, use the source generator with Node 24 from a cloned Alkemist checkout:
