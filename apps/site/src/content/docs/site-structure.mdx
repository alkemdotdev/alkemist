...
The default primary navigation is **Blog · Labs · Info**. The Alkemist demo adds a **More ›** disclosure with Docs and Test page. More supports keyboard activation, Escape to close and return focus, and dismissal by clicking outside.
