...
Start with the [setup guide](/docs/) or explore the [component catalog](/docs/components/). The same site that explains Alkemist should make it straightforward to begin using it.
