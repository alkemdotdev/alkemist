...
The first sculpture was a colored ribbon with a small companion. The next review asked for four new takes, built from scratch. [The new comparison](/labs/sculpture-studies/) starts with silhouettes: open bands, separated layers, crossing waves, and a collection of geometric objects.
