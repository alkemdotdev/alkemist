...
// Run there: playwright-cli -s=alkemist-color run-code --filename=../docs/art/capture-color-forms.cjs
// Start Astro on 4335 first. Copy the four PNGs into apps/site/src/assets/forms-color after
