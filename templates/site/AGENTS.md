...
- Read README.md and HOSTING.md before changing setup. `src/`, `public/`, and site configuration are user-owned. Alkemist's defaults live in the two packages under `vendor/`.
...
- Commit vendor tarballs and package-lock.json. Updates replace package snapshots, not this site's content or styles; inspect and test changes before accepting an update.
